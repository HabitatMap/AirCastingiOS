...
final class StringCustomizer {
    static func customizeString(_ s: String, using words: [String], fontWeight: Font.Weight = .bold, standardFontWeight: Font.Weight = .regular, color: Color = .aircastingGray, standardColor: Color = .aircastingGray, font: Font = .body, standardFont: Font = Fonts.muliRegularHeading4, makeNewLineAfterCustomized: Bool = false) -> Text {
