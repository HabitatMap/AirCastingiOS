...
struct SelectDeviceView: View {
    ...
    var body: some View {
        ...
        .background( Group {
            ...
            NavigationLink(
                destination: TurnOnBluetoothView(creatingSessionFlowContinues: $creatingSessionFlowContinues, sdSyncContinues: $sdSyncContinues, isSDClearProcess: false, urlProvider: urlProvider),
