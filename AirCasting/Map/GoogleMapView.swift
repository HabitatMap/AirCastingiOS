...
struct GoogleMapView: UIViewRepresentable {
    ...
    class Coordinator: NSObject, UINavigationControllerDelegate, GMSMapViewDelegate {
        ...
        func mapView(_ mapView: GMSMapView, didChange position: GMSCameraPosition) {
            ...
            parent.tracker.googleLocation = [PathPoint(location: CLLocationCoordinate2D(latitude: lat, longitude: len), measurementTime: DateBuilder.getDate(), measurement: 20.0)]
