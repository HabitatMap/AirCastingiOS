...
enum TestStreamGenerator {
    ...
    static func createStream(numberOfMeasurements: Int, startingDate: Date = DateBuilder.getSince1970using(0)) -> MeasurementStreamEntity {
        ...
        for index in 0..<numberOfMeasurements {
            ...
            entity.time = DateBuilder.getSince1970using(Double(index))
